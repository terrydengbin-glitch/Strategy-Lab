...
def main() -> None:
    root = ROOT
    grid_path = root / "DATA" / "backtest" / "strategy6_exit_protection_60params_STEP21_47.json"
    grid = json.loads(grid_path.read_text(encoding="utf-8"))["parameter_sets"]
    progress_path = root / "DATA" / "backtest" / "strategy6_exit_protection_STEP21_47_progress.json"
    result_path = root / "DATA" / "backtest" / "strategy6_exit_protection_STEP21_47_result.json"
