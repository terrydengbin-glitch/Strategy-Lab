...
def main() -> None:
    root = ROOT
    grid_path = root / "DATA" / "backtest" / "strategy6_wait_rebound_40params_STEP21_46.json"
    grid = json.loads(grid_path.read_text(encoding="utf-8"))["parameter_sets"]
    progress_path = root / "DATA" / "backtest" / "strategy6_wait_rebound_STEP21_46_progress.json"
    result_path = root / "DATA" / "backtest" / "strategy6_wait_rebound_STEP21_46_result.json"
